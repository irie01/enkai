...
public class ChatDao implements BaseDao<Chat> {
	...
	@Override
	public Chat findByuserId(Integer user_id) throws DataNotFoundException {
		// TODO 自動生成されたメソッド・スタブ
		return null;
	}
	
	public List<Chat> findByEventId(Integer event_id) throws DataNotFoundException {
		List<Chat> chat = this.repository.findByEventId(event_id);
		if (chat == null) {
